                                                    ...
                                                    echo $trow1['t_p_name'] .' ';
                                                         ...
                                                         ?></td>
                                                          ...
                                                          <td>
                                                              ...
                                                              <form action="update_tour_package.php" method="post">
                                                                <input type="hidden" name="tpid" value="<?php echo $trow['t_pa_id'];?>">
                                                                <button name="up" class="btn btn-primary">Update</button>
                                                                </form> 
                                                          </td>
