...
<head>
  <meta charset="UTF-8">
  <title>footer</title>
  <link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css'><link rel="stylesheet" href="css/stylefooter.css">
...
<h5 class="widget-title">TRIPPY TRIPS<span></span></h5>
<p>buy your self happiness and freedom... </p>
</div>
</div>
...
<li>
<div class="thumb-content"><a href="#.">Hire vehicals</a></div>	
</li>
...
<div class="widget no-box">
<ul>
<h5 class="widget-title">LEGAL POLICY<span></span></h5>
<li>
<div class="thumb-content"><a href="#.">Terms and Condition</a></div>	
</li>
<li>
...
<li>
<div class="thumb-content"><a href="#.">Share your Travel experience</a></div>	
</li>
</ul>
...
<p><a href="mailto:trippyytrips@gmail.com" title="glorythemes">trippyytrips@gmail.com</a></p>
...
<p>Copyright Trippy Trips © 2021. All rights reserved.</p>
</div>
</div>
</div>
</div>
...
footer{
   ...
   /* Footer Top */
   .footer-top{	background: ;	padding-bottom: 30px;	margin-bottom: 30px;	border-bottom: 3px solid #222;}
   ...
   .widget li a:hover{	color: #00FFFF;}
   ...
   .btn{background-color: #ff8d1e; color:#00FFFF;}
   .btn:hover, .btn:focus, .btn.active {background: #4b92dc;color: #00FFFF;
