                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $tsql = "select * from t_user_info where t_u_status='1'";
                                                $tre = mysqli_query($con, $tsql);
                                                while ($trow = mysqli_fetch_array($tre)) {

                                                ?>
                                                    <tr>
                                                        <td><?php echo $trow['t_u_name']; ?></td>
                                                        <td><?php echo $trow['t_u_email']; ?></td>
                                                        <td><?php echo $trow['t_u_contact']; ?></td>
                                                        <td><?php echo $trow['t_u_gender']; ?></td>
                                                        <td><?php echo $trow['t_u_address']; ?></td>
                                                        <td><?php echo $trow['t_u_city']; ?></td>
                                                        <td><?php echo $trow['t_u_state']; ?></td>
